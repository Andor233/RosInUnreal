...
bool operator==(const ::rosgraph_msgs::TopicStatistics_<ContainerAllocator1> & lhs, const ::rosgraph_msgs::TopicStatistics_<ContainerAllocator2> & rhs)
{
  return lhs.topic == rhs.topic &&
    lhs.node_pub == rhs.node_pub &&
    lhs.node_sub == rhs.node_sub &&
    lhs.window_start == rhs.window_start &&
    lhs.window_stop == rhs.window_stop &&
    lhs.delivered_msgs == rhs.delivered_msgs &&
    lhs.dropped_msgs == rhs.dropped_msgs &&
    lhs.traffic == rhs.traffic &&
    lhs.period_mean == rhs.period_mean &&
    lhs.period_stddev == rhs.period_stddev &&
    lhs.period_max == rhs.period_max &&
    lhs.stamp_age_mean == rhs.stamp_age_mean &&
    lhs.stamp_age_stddev == rhs.stamp_age_stddev &&
    lhs.stamp_age_max == rhs.stamp_age_max;
}
